...
(function () {
  ...
  (function initAIAccordion() {
    ...
    containers.forEach((container) => {
      ...
      // 1. Sticky Scroll Setup (Desktop Only)
      if (isDesktop) {
      ...
      // 2. Click Handling (Mobile & Desktop)
        ...
        if (header) {
          header.addEventListener("click", function (e) {
            ...
            if (isDesktop && wrapper) {
              // Scroll-Jacking sync: mathematically scroll page to match clicked tab
              ...
              containerAccordions.forEach((el) =>
  ...
  /**
   * Buttery Smooth Drag-to-Scroll & Infinite Auto-Scroll for Stats Slider
   */
  (function initStatsSlider() {
    ...
    sliders.forEach((slider) => {
      ...
      // Calculate the exact pixel distance to jump back for a seamless loop
      let cloneOffset = 0;
      setTimeout(() => {
      ...
      }, 200); // give DOM a moment to paint
      ...
      slider.addEventListener("mousemove", (e) => {
        ...
        // Wrap for manual drag
        if (cloneOffset > 0 && slider.scrollLeft >= cloneOffset) {
          slider.scrollLeft -= cloneOffset;
          scrollLeft -= cloneOffset; // adjust origin
